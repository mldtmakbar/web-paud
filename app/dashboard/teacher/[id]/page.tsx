...
export default function TeacherDashboardWithId() {
  ...
  console.log("TeacherDashboardWithId rendered")
  ...
  const loadStats = async () => {
    try {
      ...
      const [classesCount, studentsCount, attendanceCount] = await Promise.all([
      ...
      setStats([
        ...
        },
        {
          ...
          value: attendanceCount.count?.toString() || "0",
          icon: Calendar,
  ...
  if (loading) {
    return (
      <div style={{ 
        ...
        <h2 style={{ marginTop: '20px', color: '#333' }}>Memuat Dashboard Guru...</h2>
        <style jsx>{`
          @keyframes spin {
  ...
  if (user.role !== 'teacher') {
    ...
    return (
      <div style={{ 
        ...
        <p style={{ color: '#666' }}>Role user tidak sesuai untuk halaman guru</p>
      </div>
    )
  }
      ...
      <div className="border-b">
        <nav className="-mb-px flex space-x-8">
          {[
            ...
            { id: "attendance", label: "Kelola Kehadiran" },
