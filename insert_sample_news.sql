...
('admin-news-author', 'Admin Berita', 'admin@tkanida.com', 'admin', 'admin@tkanida.com', '081234567890')
...
(
  gen_random_uuid(),
  'Pendaftaran Siswa Baru TK Anida Tahun Ajaran 2025/2026',
  'TK Anida membuka pendaftaran siswa baru untuk tahun ajaran 2025/2026. Daftarkan putra-putri Anda sekarang!',
  'TK Anida dengan bangga mengumumkan pembukaan pendaftaran siswa baru untuk tahun ajaran 2025/2026. Kami menyediakan program pendidikan yang berkualitas dengan metode pembelajaran yang menyenangkan dan sesuai dengan perkembangan anak usia dini.\n\nFasilitas yang tersedia:\n- Ruang kelas yang nyaman dan aman\n- Playground yang luas\n- Perpustakaan anak\n- Laboratorium komputer\n- Ruang seni dan musik\n\nPendaftaran dibuka mulai tanggal 1 Januari 2025 sampai dengan 31 Maret 2025. Jangan lewatkan kesempatan emas ini!',
  'admin-news-author',
  '2025-01-15',
  'published',
  'Pendaftaran',
  '/kindergarten-registration.png',
  'pendaftaran, siswa baru, tk anida',
  true,
  NOW(),
  NOW()
),
(
  ...
  'Siswa-siswi TK Anida melakukan kunjungan edukatif ke kebun binatang untuk belajar tentang berbagai jenis hewan.',
  'Pada hari Jumat, 10 Januari 2025, siswa-siswi TK Anida melakukan kegiatan field trip ke Kebun Binatang Ragunan. Kegiatan ini bertujuan untuk memberikan pengalaman langsung kepada anak-anak dalam mengenal berbagai jenis hewan dan habitatnya.\n\nDalam kegiatan ini, anak-anak dapat:\n- Melihat berbagai jenis hewan secara langsung\n- Belajar tentang makanan dan habitat hewan\n- Mengembangkan rasa cinta terhadap alam\n- Meningkatkan keterampilan observasi\n\nAntusiasme anak-anak sangat tinggi dan mereka sangat senang dapat melihat gajah, singa, dan berbagai hewan lainnya secara langsung.',
  'admin-news-author',
  '2025-01-12',
  'published',
  'Kegiatan',
...
(
  ...
  'Siswa TK Anida berhasil meraih juara dalam lomba mewarnai tingkat kecamatan. Selamat untuk para juara!',
  'TK Anida berbangga mengumumkan prestasi membanggakan dari siswa-siswi kami dalam Lomba Mewarnai Tingkat Kecamatan yang diselenggarakan pada tanggal 15 Desember 2024.\n\nPara juara:\n- Juara 1: Aditya Pratama (Kelas B1)\n- Juara 2: Sari Indah Putri (Kelas B2)\n- Juara 3: Muhammad Rizki (Kelas A)\n- Juara Harapan 1: Zahra Aulia (Kelas B1)\n- Juara Harapan 2: Dimas Aryo (Kelas A)\n\nLomba ini diikuti oleh 50 peserta dari 10 TK se-kecamatan. Tema lomba adalah "Keindahan Alam Indonesia" dan para siswa kami menunjukkan kreativitas yang luar biasa.\n\nSelamat kepada semua pemenang! Prestasi ini membuktikan bahwa pembinaan seni di TK Anida memberikan hasil yang maksimal.',
  'admin-news-author',
  '2024-12-16',
  'published',
  'Prestasi',
