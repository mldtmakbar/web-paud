...
export const mockStudents: Student[] = [
  ...
  },
  {
    ...
    nisn: "1234567892",
    gender: "L",
    address: "Jl. Sudirman No. 67, Jakarta Pusat",
    bloodType: "B",
    allergies: "Kacang tanah",
    emergencyContact: "Ibu Rina Joko",
...
export const mockParents: Parent[] = [
  ...
  },
  {
    ...
    alamat_pekerjaan_ayah: "Jl. Thamrin No. 12, Jakarta Pusat",
    nomor_telepon_ayah: "081234567892",
    email_ayah: "joko.widodo@email.com",
    nama_ibu: "Rina Joko",
    pekerjaan_ibu: "Dokter",
    alamat_pekerjaan_ibu: "RS Jakarta Selatan",
    nomor_telepon_ibu: "081234567893",
    email_ibu: "rina.joko@email.com",
    alamat_rumah: "Jl. Sudirman No. 67, Jakarta Pusat",
